...
export default function ExpenseCustomerPanel() {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Expense Tracking (Customer)</CardTitle>
      </CardHeader>
      <CardContent>
        {submitted ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-2">
            <input
              ...
              required
            />
            <label htmlFor="expense-receipt-customer" className="sr-only">Upload receipt file</label>
            <input
              id="expense-receipt-customer"
              type="file"
